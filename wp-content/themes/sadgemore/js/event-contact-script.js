document.addEventListener('DOMContentLoaded', function() {
    ...
    const form = document.getElementById('event__form');
    const messageContainer = document.getElementById('event__form-message');
    const ajaxUrl = myAjaxEvent.ajaxurl; // Replace with the actual URL
