			...
			document.addEventListener('DOMContentLoaded', function () {
				...
				function updateTocPosition() {
					...
					if (window.innerWidth >= 1180) {
						...
						toc.classList.toggle('is-past-article', articleBottom <= tocBottom + 32);
						return;
					}

					toc.classList.remove('is-past-article');
				...
				tocLinks.forEach(function (link) {
					link.addEventListener('click', function (event) {
						...
						closeToc();
						var headerOffset = 116;
						if (window.innerWidth < 1180 && toc) {
							var stickyTop = parseFloat(window.getComputedStyle(toc).getPropertyValue('--toc-sticky-top')) || 0;
							headerOffset = stickyTop + toc.getBoundingClientRect().height + 28;
						}
